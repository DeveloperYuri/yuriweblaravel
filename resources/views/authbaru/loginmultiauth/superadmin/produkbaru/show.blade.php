                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="banner-article1 text-center" data-aos="fade-up">
                            <img src="{{ asset('/storage/produkbaru/' . $produkbaru->image) }}" class="img-fluid"
                                alt="...">
                        </div>
                        <!-- End Banner Homepage -->

                        <div class="mt-5">
                            <a href="{{ route('produkbaru.edit', $produkbaru->id)}}"
                                class="btn btn-sm btn-warning">Edit Artikel</a>
                            <a href="{{ route('produkbaru.index') }}" class="btn btn-sm btn-success">Kembali Ke Daftar Produk Baru</a>
                        </div>
