        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Preview Produk Baru</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active">Preview Produk Baru</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="banner-article1 text-center" data-aos="fade-up">
                            <img src="{{ asset('/storage/event/' . $events->image) }}" class="img-fluid"
                                alt="...">
                        </div>
                        <!-- End Banner Homepage -->

                        <div class="mt-5">
                            <a href="{{ route('editevent', $events->id)}}"
                                class="btn btn-sm btn-warning">Edit Event</a>
                            <a href="{{ route('listevent') }}" class="btn btn-sm btn-success">Kembali Ke Daftar Event</a>
                        </div>
