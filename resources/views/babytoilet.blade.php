...
<div class="container">
    ...
    <div class="banner-tentang-kami" data-aos="fade-up">
        <img src="images/babytoilet.png" class="img-fluid" alt="..." width="100%">
    </div>
    <!-- End Banner Homepage -->

    <!-- Content -->
    <div class="content-babytoilet text-center">
        <a href="https://www.yurishop.co/id/category/bayi" target="_blank"><img src="images/babytoilet1.png" class="img-fluid" alt="..."></a>
    </div>
    <!-- End Content-->
