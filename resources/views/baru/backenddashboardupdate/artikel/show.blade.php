        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="banner-article1 text-center" data-aos="fade-up">
                        <img src="{{ asset('/storage/artikelbaru/' . $artikelbaru->image) }}" class="img-fluid"
                            alt="..." onerror="this.onerror=null; this.src='{{ asset('images/logo-8.png') }}'">
                    </div>
                    <!-- End Banner Homepage -->
                    {{-- test --}}
                    ...
                    <div>
                        <a href="{{ route('artikeleditupdate', $artikelbaru->id) }}" class="btn btn-sm btn-warning">Edit
                            Artikel</a>
                        <a href="{{ route('artikelindexupdate') }}" class="btn btn-sm btn-success">Kembali Ke Daftar
                            Artikel</a>
                    </div>
