        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('createmedia') }}" class="btn btn-md btn-primary mb-3"><i
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @forelse ($getRecord as $key => $media)
                                <tr>
                                    <td class="text-center">{{ $getRecord->firstItem() + $key }}</td>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/media/' . $media->image) }}" class="rounded"
                                    ...
                                    <td class="text-center">
                                        <form
                                            action="{{ route('deletemedia', $media->id) }}" method="POST">

                                            <a href="{{ route('editmedia', $media->id) }}"
