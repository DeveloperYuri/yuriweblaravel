...
@section('head')
    ...
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Yuri Household Cleaner Produk">
        <meta name="keywords" content="yuri household cleaner">
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Yuri - Household Cleaner</title>
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="content-household">
            <div class="d-flex p-3 justify-content-center">
                <div class="p-2"><a href="{{ route('brands.aganol') }}"><img src="images/household1.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.babysoft') }}"><img src="images/household2.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.biosoftdetergen') }}"><img src="images/household3.png"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                <div class="p-2"><a href="{{ route('brands.biosoft') }}"><img src="images/household4.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.bathroomcleaner') }}"><img src="images/household5.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.yuribleach') }}"><img src="images/household6.png"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                {{-- <div class="p-2"><a href="{{ route('brands.fabriccare') }}" ><img src="images/household7.png" alt="" /></a></div> --}}
                <div class="p-2"><a href="{{ route('brands.yurisol') }}"><img src="images/household15.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.glasscleaner') }}"><img src="images/household8.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.handgel') }}"><img src="images/household9.png"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                <div class="p-2"><a href="{{ route('brands.handsoap') }}"><img src="images/household10.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.ligent') }}"><img src="images/brandligentbio.webp"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.ligentbaby') }}"><img src="images/ligentbaby.webp"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                <div class="p-2"><a href="{{ route('brands.porstex') }}"><img src="images/household14.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.porstexkloset') }}"><img src="images/household22.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.porstexreguler') }}"><img src="images/household23.png"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                <div class="p-2"><a href="{{ route('brands.taf') }}"><img src="images/household16.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.yurimatic') }}"><img src="images/household17.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.tril') }}"><img src="images/household18.png"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                <div class="p-2"><a href="{{ route('brands.laundrydisinfektant') }}"><img
                            src="images/household19.png" alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.disinfektantspray') }}"><img src="images/household20.png"
                            alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.handmoisturizer') }}"><img src="images/household21.png"
                            alt="" /></a></div>
            </div>

            <div class="d-flex p-3 justify-content-center">
                <div id="yurisoftbrands" class="p-2"><a href="{{ route('brands.yurisoft') }}"><img
                            src="images/household13.png" alt="" /></a></div>
                <div class="p-2"><a href="{{ route('brands.lysorin') }}"><img src="images/household12.png"
                            alt="" /></a></div>
    ...
    <!-- Start Footer -->
    <div class="card-footer text-body-secondary bg-dark text-center"
