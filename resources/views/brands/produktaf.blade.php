...
@section('content')
    <div class="container">
        ...
        <div class="button-brand">
            <a href="https://www.yurishop.co/id/category/Household-Cleaners/Kitchen-Cleaner" target="_blank"><img
    ...
    <!-- Start Footer -->
    <div id="footerproduktaf" class="card-footer text-body-secondary bg-dark text-center"
