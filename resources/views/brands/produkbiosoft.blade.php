...
@section('head')
    ...
    <head>
        ...
        <meta name="keywords" content="biosoft, yuri biosoft">
...
@section('content')
    <div class="container">
        <div class="caption text-center">
            <img src="images/infografisproduk/yuri/biosofthijab/logobiosofthijab.webp" alt="logobiosofthijab" width="250px">
        </div>

        <div id="imagebrand" class="row mt-3">
            <div class="col-6">
                <img class="aganol1" src="images/infografisproduk/yuri/biosofthijab/biosofthijab1.webp"
                    alt="infografisbiosofthijab1" width="100%" style="border-radius: 10%;">
            </div>
            <div class="col-6">
                <img class="aganol2" src="images/infografisproduk/yuri/biosofthijab/biosofthijab2.webp"
                    alt="infografisbiosofthijab2" width="100%" width="100%" style="border-radius: 10%;">
            </div>
            <div class="col-6 mt-3">
                <img class="aganol3" src="images/infografisproduk/yuri/biosofthijab/biosofthijab3.webp"
                    alt="infografisbiosofthijab3" width="100%" alt="" width="100%" style="border-radius: 10%;">
            </div>
            <div class="col-6 mt-3">
                <img class="aganol4" src="images/infografisproduk/yuri/biosofthijab/biosofthijab.webp"
                    alt="infografisbiosofthijab4" width="100%" width="100%" style="border-radius: 10%;">
            </div>
        </div>
