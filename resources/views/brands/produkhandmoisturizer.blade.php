...
@section('head')
    ...
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Yuri Handmoisturizer Produk">
        <meta name="keywords" content="hand moisturizer, yuri hand moisturizer">
...
@section('content')
    <div class="container">
        ...
        <div class="button-brand">
            <a href="https://www.yurishop.co/id/product/Yuri-Hand-Moisturizer-40-G" target="_blank"><img
