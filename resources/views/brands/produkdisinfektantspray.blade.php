...
@section('head')
    ...
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Yuri Disinfektant Spray Produk">
        <meta name="keywords" content="disinfektant spray, yuri disinfektant spray">
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Yuri - Disinfektan Spray</title>
...
@section('content')
    <div class="container">
        ...
        <div class="button-brand">
            <a href="https://www.yurishop.co/id/product/Yuri-Disinfectant-Spray-500-Ml-free-Disinfectant-Spray-50-Ml" target="_blank"><img
    ...
    <!-- Start Footer -->
    <div id="footerprodukdisinfektantspray" class="card-footer text-body-secondary bg-dark text-center"
