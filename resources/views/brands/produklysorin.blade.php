...
@section('head')
    ...
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Yuri Lysorin Produk">
        <meta name="keywords" content="lysorin, yuri lysorin">
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Yuri - Lysorin</title>
...
@section('content')
    <div class="container">
        ...
        <div class="caption text-center mb-4">
            <img src="images/infografisproduk/yuri/lysorin/logolysorin.png" alt="" width="150px">
        </div>

        <div class="aganolgeneral">
            <img src="images/infografisproduk/yuri/lysorin/lysorin-01.jpg" alt="" />
        </div>

        <div class="button-brand">
            <a href="https://www.yurishop.co/id/product/Lysorin-Disinfectant-1000-ml" target="_blank"><img
    ...
    <!-- Start Footer -->
    <div id="footerproduklysorin" class="card-footer text-body-secondary bg-dark text-center"
