...
@section('head')
    ...
    <head>
        <meta charset="utf-8" />
        <meta name="description" content="Yuri Babysoft Produk">
        <meta name="keywords" content="babysoft, yuri babysoft">
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Yuri - Babysoft</title>
...
@section('content')
    <div class="container">
        ...
        <div class="caption text-center mb-4">
            <img src="images/infografisproduk/yuri/babysoft/logobabysoft.webp" alt="logobabysoft" width="150px">
        </div>

        <div class="aganolgeneral">
            <img src="images/infografisproduk/yuri/babysoft/babysoft-01.webp" alt="infografisbabysoft" />
        </div>

        <div class="button-brand">
            <a href="https://www.yurishop.co/id/product/Babysoft-Fabric-Softener-1000-ml" target="_blank"><img
    ...
    <!-- Start Footer -->
    <div id="footerprodukbabysoft" class="card-footer text-body-secondary bg-dark text-center"
