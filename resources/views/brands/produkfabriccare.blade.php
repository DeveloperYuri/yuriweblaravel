...
@section('head')
    ...
    <head>
        ...
        <meta name="keywords" content="fabric care, yuri fabric care">
...
@section('content')
    <div class="container">
        ...
        <div class="caption text-center mb-4">
            <img src="images/infografisproduk/yuri/fabriccare/logofabriccare.png" alt="" width="150px">
        </div>

        <div class="aganolgeneral">
            <img src="images/infografisproduk/yuri/fabriccare/fabriccareinfograph-01.jpg" alt="" />
        </div>

        <div class="button-brand">
            <a href="https://www.yurishop.co/id/category/Household-Cleaners/" target="_blank"><img
    ...
    <!-- Start Footer -->
    <div id="footerprodukfabriccare" class="card-footer text-body-secondary bg-dark text-center"
