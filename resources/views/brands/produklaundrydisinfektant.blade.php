...
@section('head')
    ...
    <head>
        ...
        <meta name="keywords" content="laundry disinfektant, yuri laundry disinfektant">
...
@section('content')
    <div class="container">
        ...
        <div class="button-brand">
            <a href="https://www.yurishop.co/id/product/Yuri-Laundry-Disinfectant-1000-ML" target="_blank"><img
    ...
    <!-- Start Footer -->
    <div id="footerproduklaundrydisinfektant" class="card-footer text-body-secondary bg-dark text-center"
