...
<head>
    <meta charset="utf-8" />
    <meta name="description" content="Yuri Laundry Disinfektant Produk">
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Yuri - Laundry Disinfektant</title>
...
@section('content')
    <div class="container">
        <div class="laundrydisinfektan-produk mt-4" data-aos="fade-up">
            <div class="card mb-3 mx-auto" style="max-width: 900px;">
                <div class="row g-0">
                    <div class="col-lg-4">
                        <img src="images/produklaundrydisinfektant.png" class="img-fluid rounded-start">
                    </div>
                    <div class="col-lg-8">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #005EB8;">
                                Yuri Laundry Disinfectant</h5>
                            <p class="card-text mt-3" style="text-align: justify;">
                                - Membunuh kuman penyakit yang melekat pada pakaian, masker kain, jaket dll.
                                <br>- Menghilangkan bau apek dan keringat.
                                <br>- Dapat digunakan untuk pencucian secara manual atau menggunakan mesin cuci.
                                <br>- Dapat membunuh kuman bakteri penyebab penyakit.
                                <br>- Tidak merusak pakaian.
                            </p>
