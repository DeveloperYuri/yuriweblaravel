...
<head>
    <meta charset="utf-8" />
    <meta name="description" content="Media Kami">
    <meta name="keywords" content="yuri media">
                ...
                @forelse ($media as $m)
                    <div class="col-md-4">
                        <div class="card h-100">
                            <img src="{{ asset('/storage/artikels/' . $m->image) }}" class="card-img-top"
                                alt="..." width="400px" height="230px">
                            <div class="card-body">
                                <a href="{{ $m->link }}" target="_blank">
                                <p class="card-title" style="font-size: 20px; font-weight:bold;">{{ $m->title }}</p>
                                </a>
                            </div>
